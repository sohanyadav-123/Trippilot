          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[11px] opacity-80 block mt-0.5">
                {travelMode === 'family'
                  ? 'Showing kid-friendly resorts with swimming pools, adjoining family rooms & play areas.'
                  : 'Prioritizing step-free accessible entrances, elevator access & ground-floor options.'}
              </span>
            </div>
          </div>
          <button
