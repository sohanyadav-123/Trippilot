...
export const Navbar: React.FC = () => {
  ...
  const currentModeObj = travelModes.find((m) => m.mode === travelMode) || travelModes[0];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4 h-11">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5">
            {/* Travel Experience Mode Dropdown */}
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1.5 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 hover:bg-slate-50 transition-all"
                title={t('label.choose_language', 'Select Language')}
                aria-haspopup="true"
              ...
              {languageDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-2xl shadow-luxury border border-slate-200 py-2 z-50 animate-in fade-in slide-in-from-top-1">
                  <div className="px-3 py-1.5 border-b border-slate-100">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">
                      {t('label.choose_language', 'Choose Language')}
                    </span>
                  </div>
                  {languages.map((l) => (
                    <button
